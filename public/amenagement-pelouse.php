...
<head>
    <meta charset="UTF-8">
    <title>Aménager votre pelouse - Famiflora</title>
        ...
        function onPlayerStateChange(event) {
            if (event.data == YT.PlayerState.ENDED) {
                fetch('valider_vue.php', {
                    ...
                    body: 'nom_page=amenagement_pelouse'
                }).then(() => {
