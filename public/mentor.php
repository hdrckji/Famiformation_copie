...
<div class="container">
    ...
    <div class="pdf-viewer">
        ...
        <iframe src="mentor.pdf#toolbar=1" type="application/pdf" style="width:100%;height:80vh;min-height:400px;max-height:1200px;border-radius:12px;border:1px solid #eee;background:white;"></iframe>
    </div>
    <a href="quiz_engine.php?theme=quiz_mentor" class="btn-quiz">📝 Passer le Quiz de validation</a>
    <style>
