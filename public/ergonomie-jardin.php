...
<head>
    ...
    <title>Formation - Ergonomie au Jardin - Famiflora</title>
    ...
    <style>
        ...
        .btn-start:hover { background: #214429; }
        .btn-start:disabled { background: #ccc; cursor: not-allowed; }
        
        .instruction { font-style: italic; color: #666; margin-top: 15px; }
      /* La fenêtre modale personnalisée */
.modal-overlay {
    display: none;
    position: fixed;
...
<body>
  <div id="successModal" class="modal-overlay">
    ...
    <div class="container">
        <h1>Jardiner de manière ergonomique</h1>
    ...
    if (event.data == YT.PlayerState.ENDED) {
        ...
        fetch('valider_vue.php', {
            ...
            body: 'nom_page=ergonomie_travail' // /!\ Change le nom selon la page
        }).then(() => {
