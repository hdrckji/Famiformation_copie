...
<head>
    ...
    <title>Entretien de collaboration - FamiFormation</title>
    ...
    <style>
        ...
        .pdf-viewer { background: white; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,0.08); padding: 30px; margin-bottom: 30px; text-align: center; }
...
<div class="container">
    ...
    <h1>Entretien de collaboration</h1>
    <div class="pdf-viewer">
        <p><strong>Support de formation :</strong></p>
        <iframe src="evolution.pdf#toolbar=1" type="application/pdf" style="width:100%;height:80vh;min-height:400px;max-height:1200px;border-radius:12px;border:1px solid #eee;background:white;"></iframe>
    </div>
    <a href="quiz_engine.php?theme=quiz_entretien" class="btn-quiz">📝 Passer le Quiz de validation</a>
    <style>
    @media (max-width: 700px) {
        .pdf-viewer iframe { height: 60vh !important; min-height: 220px !important; }
    }
    </style>
</div>
</body>
