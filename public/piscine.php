...
<head>
    <meta charset="UTF-8">
    <title>Piscine - FamiFormation</title>
...
<body>
    ...
    <iframe src="piscine.pdf" class="pdf-frame"></iframe>
    <div style="margin: 40px auto; text-align: center;">
        <a href="quiz_engine.php?theme=quiz_engin" style="display:inline-block; background:#2d5a37; color:#fff; font-weight:bold; padding:18px 40px; border-radius:30px; font-size:1.2rem; text-decoration:none; box-shadow:0 4px 16px rgba(45,90,55,0.12); transition:background 0.3s;">Lancer le quizz Engin</a>
    </div>
</body>
</html>
