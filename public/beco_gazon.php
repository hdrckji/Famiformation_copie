...
<head>
    ...
    <title>Commande Gazon - FamiFormation</title>
...
<nav>
    ...
    <span>Formation : Commande Gazon</span>
    <div style="font-size: 0.8em; opacity: 0.8;">Famiflora</div>
</nav>
<div class="pdf-container">
    <iframe src="commandegazon.pdf#toolbar=0"></iframe>
</div>
<div class="quiz-action-container">
    <a href="quiz_engine.php?theme=quiz_gazon" class="btn-quiz">📝 Commencer le Quiz Gazon</a>
</div>
</body>
</html>