...
<head>
    ...
    <title>Donner du feedback - FamiFormation</title>
    ...
    <style>
        ...
        .pptx-viewer { background: white; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,0.08); padding: 30px; margin-bottom: 30px; text-align: center; }
...
<div class="container">
    ...
    <h1>Donner du feedback</h1>
    <div class="pptx-viewer">
        <p><strong>Support de formation :</strong></p>
        <iframe src="feedback.pdf#toolbar=1" type="application/pdf" style="width:100%;height:80vh;min-height:400px;max-height:1200px;border-radius:12px;border:1px solid #eee;background:white;"></iframe>
    </div>
    <style>
    @media (max-width: 700px) {
        .pptx-viewer iframe { height: 60vh !important; min-height: 220px !important; }
    }
    </style>
