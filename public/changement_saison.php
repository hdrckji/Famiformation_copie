...
<head>
    ...
    <title>Changement de saison - FamiFormation</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>Changement de saison</h1>
        <p class="instruction">Veuillez regarder la vidéo ci-dessous avant de lancer le quiz.</p>
        <div class="video-wrapper">
            <iframe id="player" src="https://www.youtube.com/embed/XC8iWMt_58A?rel=0&modestbranding=1&controls=1" allowfullscreen></iframe>
        </div>
        <div style="margin: 40px auto; text-align: center;">
            <a href="quiz_engine.php?theme=quiz_changement_saison" style="display:inline-block; background:#2d5a37; color:#fff; font-weight:bold; padding:18px 40px; border-radius:30px; font-size:1.2rem; text-decoration:none; box-shadow:0 4px 16px rgba(45,90,55,0.12); transition:background 0.3s;">Lancer le quiz Changement de saison</a>
        </div>
    </div>
</body>
</html>
