...
<head>
    ...
    <title>Formation - Protection des plantes en hiver - Famiflora</title>
...
<body>
    ...
    <div class="container">
        <h1>Protection des plantes en hiver</h1>
        ...
        <p class="instruction" id="status-msg">La vidéo doit être vue entièrement.</p>
    </div>
        ...
        function onPlayerStateChange(event) {
            if (event.data == YT.PlayerState.ENDED) {
                fetch('valider_vue.php', {
                    ...
                    body: 'nom_page=protection_hiver'
                }).then(() => {
